...
## Section 1: Screening & Usage Habits
...
**2. What categories do you typically buy on Blinkit? (Select all that apply)**
- [ ] Groceries & Staples
...
- [ ] No, I considered it but decided against it

---

## Section 2: Hypothesis 1 - Dispute Resolution Experience
*(Only ask if they have returned an item or faced an issue)*

**4. Think about the last time you received a damaged, incorrect, or defective item from Blinkit. How did you handle it?**
- *[Short Answer text box]*

**5. How would you rate the ease of the refund/return process for that specific issue?**
- [ ] 1 - Extremely difficult and frustrating (Bot loops, took days)
...
## Section 3: Hypothesis 2 - Hidden Friction (Category Avoidance)

**7. If you needed a phone charger urgently, and you saw it available on Blinkit for ₹800, what is the primary reason you might choose NOT to buy it there?**
- [ ] Price (It might be cheaper on Amazon/offline)
- [ ] Trust/Authenticity (I'm worried it might be fake)
- [ ] Return Anxiety (I'm worried the return process will be difficult if it's defective)
- [ ] Quality (I prefer checking electronics in person)
- [ ] I *would* buy it on Blinkit without hesitation.
- [ ] Other: ______________

**8. Have you ever abandoned your Blinkit cart containing a non-grocery item (cosmetics, appliances) specifically because you were worried about the return policy?**
- [ ] Yes
- [ ] No
- [ ] Can't remember
...
- [ ] Clearer visual tags showing the product is "Brand Verified & Certified"
- [ ] Other: ______________

**11. Is there anything else you'd like to share about your experience dealing with Blinkit's customer support?**
